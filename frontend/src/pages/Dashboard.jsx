    ...
    return (
        <div className={WRAPPER}>
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    {filterTasks.length === 0 ? (
                        ...
                        filterTasks.map(task => (
                            ...
                            onEdit = {() => {setSelectedTask(task) ; showModal(true)}} />
                        ))
                    )}
                ...
                <div onClick = {() => setShowModal(true)} className="hidden md:flex items-center p-4 border-2 border-dashed border-purple-200 
