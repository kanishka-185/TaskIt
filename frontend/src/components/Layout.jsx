...
import { TrendingUp,Circle,Clock,CircleCheckBig } from "lucide-react";
    ...
    if(error) return(
        <div className="min-h-screen bg-gray-50 p-6 flex-items-center justify-center">
            <div className="bg-red-50 text-red-600 p-4 rounded-xl border border-red-100 max-w-md">
                <p className="font-medium mb-2 text-center">Error loading tasks</p>
                    ...
                    <div className="xl:col-span-1 space-y-4 sm:space-y-6">
                        <div className="bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100">
                            ...
                            <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6">
                                ...
                                <StatCard title='Completion Rate' value={`${stats.completionPercentage}%`} icon={<CircleCheckBig className='w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-500'/>}/>
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                <div className="flex items-center justify-between text-gray-700">
                                    ...
                                    <span className="text-xs bg-purple-100 text-purple-700 px-1.5 py-0.5 sm:x-2 rounded:full">
                                ...
                                <div className="relative pt-1">
                                    <div className="flex gap-1.5 items-center">
                                        <div className="flex-1 h-2 sm:h-3 bg-purple-100 rounded-full overflow-hidden">
                                            <div className="h-full bg-gradient-to-r from bg-fuchsia-500 to-purple-600 transition-all duration-500"
                            ...
                            <div className="space-y-2 sm:space-y-3">
                                {tasks.slice(0,3).map((task) => (
                                    <div key={task._id || task.id} className="flex items-center justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-lg transition-colors duration-200 border border-transparent hover:border-purple-100" >
                                        ...
                                        <span className={`px-2 py-2 text-xs rounded-full shrink-0 ml-2 ${task.completed ? 'bg-green-100 text-green-700':'bg-fuchsia-100 text-fuchsia-700'}`}>
